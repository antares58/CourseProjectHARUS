...
A brief summary of the data, a description of the processing and analysis performed on the original data, and a description of the resulting data can be found in CodeBook.md.
...
The results of the analysis can be found in HARUS Averages.txt, which is a  text file with headings. This data set is tidy (narrow form), according to Hadley Wickham's criteria for tidy data:
